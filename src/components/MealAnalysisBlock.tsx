...
const MealAnalysisBlock: React.FC<Props> = ({ }) => {
  return (
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex flex-col gap-6 flex-1">
            ...
            <div className="rounded-xl overflow-hidden">
              <img src="https://images.unsplash.com/photo-1535914254981-b5012eebbd15?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="" className="w-300 h-50 object-cover" />
            </div>
          </div>
...
export default MealAnalysisBlock;
